package com.kuro.mycatering.main.main;
...
import com.kuro.mycatering.main.history.HistoryOrderActivity;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (lokasi.equals("") && tujuan.equals("")){
                    Toast.makeText(MainActivity.this, "Input Lokasi dan Tujuan anda", Toast.LENGTH_SHORT).show();
                }else{
